...
def train(args):
    ...
    train_data = load_detection_data('Data/dense_data/train', num_workers=4, transform=transform)
    ...
    for epoch in range(args.num_epoch):
        ...
        for img, gt_det, gt_size in train_data:
            ...
            if train_logger is not None and global_step % 100 == 0:
                ...
                train_logger.add_images('label', gt_det[:16], global_step)
                train_logger.add_images('pred', torch.sigmoid(det[:16]), global_step)
